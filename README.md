...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/jolly-butterfly-4264
```

A live public deployment of this template is available at [https://jolly-butterfly-4264.templates.workers.dev](https://jolly-butterfly-4264.templates.workers.dev)
